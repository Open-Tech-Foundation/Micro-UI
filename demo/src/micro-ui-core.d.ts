declare module "@opentf/micro-ui" {
  ...
  export namespace html {
    export function raw(strings: TemplateStringsArray, ...values: any[]): any;
  }
  ...
  export function onError(handler: (target: HTMLElement, err: Error, phase: "setup" | "render" | "reconcile") => void): void;
}
